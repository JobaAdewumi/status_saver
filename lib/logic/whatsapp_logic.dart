...
class WhatsappLogic {
  ...
  Future init(
    ...
    if (onStart) {
      ///whatsapp
      await GlobalFunctions().getFileTypes(wNewPath, wNewPath11).then((value) {
        print(value);
      ...
      await GlobalFunctions()
          .getFileTypes(wbNewPath, wbNewPath11)
          .then((value) {
        print(value);
      ...
      if (appLogic.androidVersion! <= 29) {
        ///saved status
        await GlobalFunctions().getFileTypes(ssNewPath, '').then((value) {
